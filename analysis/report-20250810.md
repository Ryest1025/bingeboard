# Unused Code & Dependency Report (20250810)

## Summary
- Status: PASS
- Exports: current=681 baseline=681 new=0 removed=0 growth=0%
- Deps: current=0 baseline=0 new=0 removed=0
- Thresholds: exports(new warn/fail=0/5, growth warn/fail=0%/5%), deps(new warn/fail=1/5)

## Unused Export Group Summary
- shared: 9
- server/storage.ts: 1
- server/stability-monitor.ts: 2
- server/services: 8
- server/routes: 6
- server/db: 169
- server/clients: 4
- client/src/pages: 36
- client/src/firebase: 29
- client/src/components/watch-now-button.tsx: 1
- client/src/components/watchlist-manager.tsx: 1
- client/src/components/ui: 177
- client/src/components/subscription-plans.tsx: 1
- client/src/components/streaming-marquee-modal.tsx: 1
- client/src/components/streaming: 1
- client/src/components/sports-card.tsx: 2
- client/src/components/show-card.tsx: 1
- client/src/components/share-button.tsx: 2
- client/src/components/SessionStatusButton.tsx: 1
- client/src/components/search-alerts.tsx: 1
- client/src/components/search: 7
- client/src/components/RecommendationCard.tsx: 1
- client/src/components/premium-features-showcase.tsx: 1
- client/src/components/premium-feature-gate.tsx: 1
- client/src/components/premium-badge.tsx: 2
- client/src/components/preferences-panel.tsx: 1
- client/src/components/preferences: 4
- client/src/components/onboarding-modal.tsx: 1
- client/src/components/onboarding: 6
- client/src/components/navigation-header-fixed.tsx: 1
- client/src/components/navigation-header-backup.tsx: 1
- client/src/components/monetization-dashboard.tsx: 1
- client/src/components/layout.tsx: 2
- client/src/components/index.ts: 1
- client/src/components/filters: 12
- client/src/components/enhanced-onboarding-modal.tsx: 1
- client/src/components/enhanced-advanced-search.tsx: 1
- client/src/components/discover-filters.tsx: 1
- client/src/components/debug-ai-recommendations.tsx: 1
- client/src/components/dashboard: 13
- client/src/components/consent-banner.tsx: 1
- client/src/components/competitive-advantages.tsx: 1
- client/src/components/common: 5
- client/src/components/category-icons.tsx: 7
- client/src/components/BrandShowcase.tsx: 1
- client/src/components/affiliate-monetization.tsx: 1
- client/src/components/advanced-search.tsx: 1
- client/src/components/ad-player.tsx: 1
- client/src/components/activity-item.tsx: 1
- client: 150
...
## Full Unused Export List (filtered)
\n```
