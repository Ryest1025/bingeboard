...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Firebase authentication only - server-side OAuth routes removed

  // OAuth callback handlers removed - Firebase authentication only
  ...
  // OAuth test endpoint removed - Firebase authentication only
