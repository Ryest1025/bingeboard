...
import { Sparkles, ArrowRight, Tv, Zap, Users, Bell, Target, CheckCircle, X } from "lucide-react";
      ...
      case 1:
        return (
          <div className="text-center">
            {/* Integrated Hero Section with Text in Glow */}
            <div className="relative mx-auto space-y-4">
              {/* Hero Icon */}
              <div className="relative mx-auto mb-8">
                <div className="w-20 h-20 bg-gradient-to-r from-teal-500 via-cyan-500 to-blue-500 rounded-full flex items-center justify-center shadow-2xl">
                  <Sparkles className="h-10 w-10 text-white" />
                </div>
                <div className="absolute -inset-1 bg-gradient-to-r from-teal-400 via-cyan-400 to-blue-400 rounded-full blur-lg opacity-20"></div>
              </div>

              {/* Welcome Text - Positioned in the glow area */}
              <div className="space-y-3 -mt-4">
                ...
                <p className="text-lg text-gray-300 max-w-md mx-auto">
                  Hi {userDisplayName}! Let's customize your entertainment experience and get started.
                </p>
              </div>
            </div>
          </div>
        ...
        return (
          <div className="text-center space-y-8">
            ...
            <div className="relative mx-auto">
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-full blur-lg opacity-20"></div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                size="sm"
                onClick={onComplete}
                className="text-gray-400 hover:text-white hover:bg-slate-800/50 rounded-lg p-2"
