...
export default function OnboardingModal({ isOpen, onComplete, userDisplayName }: OnboardingModalProps) {
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-gray-300">Tell us about your viewing habits (select at least one)</p>
            </div>
            <div className="space-y-6">
              <div>
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl max-h-[90vh] glass-effect border-teal-500/20 rounded-2xl shadow-2xl animate-slide-down flex flex-col">
        {/* Fixed Header with Premium Design */}
        <div className="flex-shrink-0 p-8 border-b border-slate-700/50">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-gradient-to-br from-teal-500 via-cyan-500 to-blue-500 rounded-xl flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Step {currentStep} of 9 • Personalizing your experience
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full">
            <div className="flex justify-between items-center mb-3">
              ...
              <span className="text-sm text-gray-400">{Math.round((currentStep / 9) * 100)}% Complete</span>
            </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 scroll-container">
          <div className="max-w-3xl mx-auto">
            {renderStep()}
          </div>
        </div>
        
        {/* Fixed Footer with Premium Styling */}
        <div className="flex-shrink-0 p-8 border-t border-slate-700/50 bg-gradient-to-r from-slate-900/50 to-slate-800/50 rounded-b-2xl">
          <div className="flex justify-between items-center max-w-3xl mx-auto">
            <Button
              ...
              className="border-slate-600 text-gray-300 hover:bg-slate-700 hover:border-slate-500 px-6 py-3 text-base disabled:opacity-50"
            >
              Previous
            </Button>
            ...
            {currentStep < 9 ? (
              <Button
                onClick={handleNext}
                className="bg-gradient-to-r from-teal-600 via-cyan-600 to-blue-600 hover:from-teal-700 hover:via-cyan-700 hover:to-blue-700 text-white px-8 py-3 text-base font-semibold shadow-lg"
                disabled={
