                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    {["public", "friends", "private"].map((privacy) => (
                      <div
                        key={privacy}
                        className={`p-4 border rounded-lg cursor-pointer transition-colors ${onboardingData.preferences.privacy === privacy
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {SPORTS.map((sport) => (
                        <div
                          key={sport}
                          className={`p-3 rounded-lg border-2 cursor-pointer transition-all ${onboardingData.preferences.favoriteSports.includes(sport)
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <div className={`w-3 h-3 rounded-full border-2 ${onboardingData.preferences.favoriteSports.includes(sport)
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              {TEAMS[sport as keyof typeof TEAMS]?.slice(0, 8).map((team) => (
                                <Badge
                                  ...
                                  className={`cursor-pointer transition-all hover:scale-105 p-2 text-xs ${onboardingData.preferences.favoriteTeams.includes(team)
