...
import { X, Info, Youtube, Play, Plus, Calendar, Star } from "lucide-react";
      ...
      switch (event.key) {
        ...
        case 'ArrowRight':
          ...
          setActiveTab(current => 
            current === 'details' ? 'trailer' : 'details'
          );
          break;
        case '1':
          event.preventDefault();
        ...
        <div className="relative w-full h-full">
                      ...
                      <div className="flex-1 space-y-3">
                        ...
                        <div className="flex flex-wrap gap-3">
                          ...
                          {onAddToList && (
                            <Button
                              variant="outline"
                              onClick={() => onAddToList(show)}
                              className="border-white/30 text-white hover:bg-white/20 hover:text-white font-semibold px-6"
                            >
              ...
              <div className="p-6 overflow-y-auto max-h-[calc(90vh-16rem)]" id="modal-content">
                ...
                <div className="relative mb-6">
                  <div className="flex items-center gap-8 border-b border-slate-700" role="tablist" aria-label="Content tabs">
                    <motion.button
