...
export default function MobileHub() {
  ...
  const mobileOptions = [
    {
      title: 'Mobile Login',
      description: 'Optimized mobile authentication experience',
      icon: <LogIn className="h-6 w-6" />,
      path: '/mobile-social-login',
      color: 'bg-blue-500'
    },
    {
      title: 'Mobile Test Suite',
      description: 'Comprehensive mobile functionality testing',
    ...
    {
      title: 'Firebase Test',
      description: 'Firebase authentication testing',
    ...
    {
      title: 'Auth Test',
      description: 'Complete authentication testing suite',
