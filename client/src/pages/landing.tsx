          ...
          <div className="text-center space-y-6 sm:space-y-8">
            ...
            <div className="flex flex-col gap-4 justify-center max-w-md mx-auto" data-join-section>
              <Button 
                ...
                onClick={() => {
                  console.log('Navigating to login page for Google authentication...');
                  setLocation('/login');
                }}
              >
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-blue-400/30 text-blue-300 hover:bg-blue-500/10 px-8 py-4 text-lg w-full"
                onClick={() => {
                  console.log('Navigating to login page for Facebook authentication...');
                  setLocation('/login');
                }}
              >
                <svg className="w-5 h-5 mr-3" viewBox="0 0 24 24" fill="currentColor">
