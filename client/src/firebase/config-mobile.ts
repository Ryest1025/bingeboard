// Firebase Mobile Configuration - Import from main config
export * from './config';
...
// This file imports everything from the main config to maintain compatibility
// with any mobile-specific code that expects config-mobile.ts to exist